    ...
    <div className="flex flex-row relative items-center justify-center min-h-[60vh] w-full h-full -z-20">
      ...
      <div className="w-full flex items-start justify-center absolute">
        <video
          ...
          playsInline
          preload="false"
          className="w-full h-auto hue-rotate-[210deg] [-webkit-mask-image:radial-gradient(50%_50%_at_50%_50%,#000_40%,transparent_100%)] [mask-image:radial-gradient(50%_50%_at_50%_50%,#000_40%,transparent_100%)]"
        >
